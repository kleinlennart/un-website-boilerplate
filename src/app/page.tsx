    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1 bg-background px-6 py-8">
        <div className="mx-auto max-w-4xl">
          ...
          <section className="mt-12">
            ...
            <div className="grid grid-cols-2 gap-4 sm:grid-cols-3">
              {[
                ...
                { name: "Camouflage Green", color: "bg-camouflage-green", hex: "#7D8471" },
                { name: "Pale Oyster", color: "bg-pale-oyster", hex: "#9B8B7A" },
                { name: "Au Chico", color: "bg-au-chico", hex: "#A0665C" },
                { name: "Smoky", color: "bg-smoky", hex: "#6C5B7B" },
                { name: "Shuttle Gray", color: "bg-shuttle-gray", hex: "#5A6C7D" },
          ...
          {/* Grayscale Showcase */}
          <section className="mt-12">
            <h2 className="mb-2 text-2xl font-bold text-foreground">Grayscale</h2>
            <a href="https://tailwindcss.com/docs/colors" target="_blank" rel="noopener noreferrer" className="mb-6 inline-block text-sm text-un-blue hover:underline">from Tailwind CSS</a>
          ...
          <section className="mt-12 mb-12">
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={t.label} className={i < arr.length - 1 ? "border-b border-gray-200 pb-4" : ""}>
                  <p className="mb-2 text-xs text-gray-600">{t.label}</p>
                  <p className={`${t.className} text-foreground`}>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                </div>
              ))}
            </div>
          </section>
